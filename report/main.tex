...
% ===========================================
                       % self-explanatory
\begin{document}
\title{Analyzing Covid data to discover factors associated with death and hospitalization}  % self-explanatory
